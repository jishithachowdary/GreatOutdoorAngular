...
@Component({
  selector: 'app-admin-home-appliances',
  templateUrl: './admin-home-appliances.component.html',
  styleUrls: ['./admin-home-appliances.component.css']
})
export class AdminHomeAppliancesComponent implements OnInit {
  allProducts:product[];
  prodcut:product;
  ...
  ngOnInit(): void {
    this.productService.getProductByCategory('home appliance').subscribe(data=>{
  ...
  productAddForm=new FormGroup({
    ...
    image:new FormControl('',[Validators.required]),
    color:new FormControl('',[Validators.required]),
    category:new FormControl({value:'home appliance',disabled:true},[Validators.required]),
    quantity:new FormControl('',[Validators.required]),
    manufacturer:new FormControl('',[Validators.required]),
    specification:new FormControl('',[Validators.required])
  });
  ...
  onAdd(){
    ...
    addProduct.category="home appliance";
